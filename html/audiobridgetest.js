						...
						janus.attach(
							{
								...
								consentDialog: function(on) {
									...
									if(on) {
										...
										$.blockUI({
											message: '<div><img src="assets/up_arrow.png"/></div>',
											css: {
												border: 'none',
												padding: '15px',
													...
													mixertest.createOffer(
														{
															...
															error: function(error) {
																...
																if (error == "getUserMedia not available")
																	return bootbox.alert("getUserMedia not available, likely because your browser prohibits accessing user media over insecure connections");
											...
											if(msg["participants"]) {
												...
												if(msg["error_code"] === 485) {
													...
													bootbox.alert(
														...
														"does not exist...</p><p>have you updated the <code>janus.plugin.audiobridge.jcfg</code> " +
														"configuration file?"
													);
												} else {
...
function registerUsername() {
	if($('#username').length === 0) {
		...
		var register = { request: "join", room: myroom, display: username, secret: "T8O37DCR7DEKJSZPD1O2"};
